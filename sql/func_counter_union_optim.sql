CREATE OR REPLACE FUNCTION public.counter_union_optim(
	_antenna_1 text,
	_rssi_1 integer,
	_antenna_2 text,
	_rssi_2 integer,
        ...
        LATERAL (
          SELECT *
            FROM public.counter_union(_antenna_1, _rssi_1, _antenna_2, _rssi_2,
	                                    t, t, _android_oui, _android_ratio, _wifi_ratio,
                                      _random_rssi_1, _random_rssi_2,
                                      _seamless, _seamless_diff, _seamless_start_time,
                                      _seamless_new_rssi_1, _seamless_new_rssi_2, _seamless_new_ratio)) as s
    )
